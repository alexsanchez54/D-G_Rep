...
study2 <- read.delim("myData2.txt")
study3 <- read.delim("myData3.txt")
study4 <- read.delim("myData4.txt")
study5 <- read.delim("myData5.txt")
study6 <- read.delim("myData6.txt")
study7 <- read.delim("myData7.txt")
studyrep <- read.delim("mydatarep.txt")

myColNames <- Reduce(intersect, list(colnames(study2), colnames(study3), colnames(study4),
                       colnames(study5), colnames(study6), colnames(study7),
                       colnames(studyrep)))

myColNames2 <- unique(c(colnames(study2), colnames(study3), colnames(study4),
                    colnames(study5), colnames(study6), colnames(study7),
                    colnames(studyrep)))
